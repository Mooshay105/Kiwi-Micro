	...
	return (
		<React.StrictMode>
			<div className="main">
				...
				<CustomBreak height={1} />
				<GalleryItem headerText="Linux Clone" description="Linux Clone is a clone of Linux I made for some fun, and I am currently moving it to react." buttonText="Visit" buttonDestination="https://linux.malcolmjh.com" imageURL={linuxClone} leftOrRight="right" />
